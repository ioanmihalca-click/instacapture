<div class="flex flex-col items-start justify-center max-w-3xl px-2 mx-auto mt-8 space-y-12 md:mt-24"
     x-data="{ 
    ...
    <div class="w-full md:space-y-3"
        ...
        <p class="pb-4 text-lg leading-relaxed text-white md:text-xl">
